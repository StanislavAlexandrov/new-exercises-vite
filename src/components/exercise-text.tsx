...
const ExerciseText = () => {
    ...
    return (
        <>
            <div className="exercise-articles flex flex-col text-3xl m-2 justify-center items-center h-screen w-full p-10">
                <p>
            ...
            <style>{`
                .translatable-word {
                    background-color: #f0f0f0; /* Subtle background highlight */
                    cursor: pointer;
                }
